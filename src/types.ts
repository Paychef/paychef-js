...
export type Currency = string; // ISO 4217, e.g. 'CHF', 'EUR', 'USD'
...
export interface GatewayCreateParams {
  ...
  reservation?: boolean;
  referenceId?: string;
  fields?: Record<string, { value?: string; mandatory?: boolean }>;
...
export interface Transaction {
  ...
  psp?: string;
  pspId?: number;
  payment?: { brand?: string; [key: string]: unknown };
  amount: number;
  currency?: Currency;
  referenceId?: string;
...
// ---------------------------------------------------------------------------
// QR code, signature check, auth token, bill
// ---------------------------------------------------------------------------
